...
(web: [`comment.io`](https://comment.io),
 issues & integration samples @ github: [`comment-io/comment.io`](https://github.com/comment-io/comment.io)) - Agent-native document editor. @mention an agent — it reads the doc and responds via webhook, autonomously. Humans and agents reading, commenting, and editing markdown together, with per-edit authorship tracking.
...
**MarkViewer** 
(web: [`markviewer.com`](https://markviewer.com), download @ github [`SeungbinBaik/markviewer-releases`](https://github.com/SeungbinBaik/markviewer-releases)) - 
...
**Textox**
(web: [`apps.apple.com/cn/app/textox-markdown-%E7%BC%96%E8%BE%91%E5%99%A8/id6762083180`](https://apps.apple.com/cn/app/textox-markdown-%E7%BC%96%E8%BE%91%E5%99%A8/id6762083180), Lite (free) @ [`apps.apple.com/cn/app/textox-markdown-lite/id6777365755`](https://apps.apple.com/cn/app/textox-markdown-lite/id6777365755), Windows @ [`apps.microsoft.com/detail/9PM13WBD5SSC`](https://apps.microsoft.com/detail/9PM13WBD5SSC)) (free Lite version, $3.99 full version) - Native WYSIWYG Markdown editor built with Tauri 2 for macOS and Windows. Renders Markdown live as you type with a source mode for manual control, LaTeX math, Mermaid diagrams, Excalidraw drawings, code syntax highlighting, task lists, table editing, PDF export, and bookmark management. Local-first with no account required; UI translated into 15 languages.
